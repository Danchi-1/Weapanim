// Initial Anime Weapon Catalog Data
const INITIAL_WEAPON_CATALOG = [
    {
      ...
      price: 1999.99,
      image: "https://maxm-imggenurl.web.val.run/bleach-zangetsu-sword"
    },
    {
      id: 2,
      ...
      price: 2499.99,
      image: "https://maxm-imggenurl.web.val.run/fate-excalibur-sword"
    },
    {
      id: 3,
      ...
      price: 1799.99,
      image: "https://maxm-imggenurl.web.val.run/sao-elucidator-sword"
    },
    {
      id: 4,
      name: "Tessaiga",
      ...
      <div class="anime-weapon-store">
        <nav class="main-nav">
          ...
          <div class="nav-links">
            ...
            <button class="nav-link">💰 Sell Weapon</button>
            <button class="nav-link">🛒 Cart (0)</button>
          </div>
        </nav>
        <div class="home-page">
